 ...
 * * Creates the required nework shares and directories in the fileserver EC2 instance
...
locals {
  index_file_path               = "../config/arcgis-enterprise-s3files-${var.arcgis_version}.json"
