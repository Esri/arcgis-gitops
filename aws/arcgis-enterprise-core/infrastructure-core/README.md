...
| Name | Type |
|------|------|
| [aws_backup_vault.enterprise](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/backup_vault) | resource |
...
| [aws_sns_topic.enterprise_alarms](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sns_topic) | resource |
...
|------|-------------|------|---------|:--------:|
| admin_email | ArcGIS Enterprise administrator e-mail address | `string` | `null` | no |
