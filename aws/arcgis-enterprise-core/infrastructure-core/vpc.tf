...
resource "aws_security_group" "vpc_endpoints_sg" {
  name        = "${var.enterprise_id}-vpc-endpoints"
...
resource "aws_vpc_endpoint" "gateway" {
  ...
  tags = {
    Name = "${var.enterprise_id}-${var.gateway_vpc_endpoints[count.index]}"
  }
}
...
resource "aws_vpc_endpoint" "interface" {
  ...
  tags = {
    Name = "${var.enterprise_id}-${var.interface_vpc_endpoints[count.index]}"
  }
}
...
resource "aws_route_table" "rtb_internal" {
  ...
  tags = {
    Name = "${var.enterprise_id}/internal-route-table"
  }
}
...
resource "aws_route_table" "rtb_private" {
  ...
  tags = {
    Name = "${var.enterprise_id}/private-route-table"
  }
}
...
resource "aws_route_table" "rtb_public" {
  ...
  tags = {
    Name = "${var.enterprise_id}/public-route-table"
  }
}
...
resource "aws_subnet" "internal_subnets" {
  ...
  tags = {
    Name = "${var.enterprise_id}/internal-subnet-${count.index + 1}"
  }
}
...
resource "aws_subnet" "private_subnets" {
  ...
  tags = {
    Name                              = "${var.enterprise_id}/private-subnet-${count.index + 1}"
...
resource "aws_subnet" "public_subnets" {
  ...
  tags = {
    Name                     = "${var.enterprise_id}/public-subnet-${count.index + 1}"
