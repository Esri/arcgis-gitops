...
# Runs {enterprise id}-install-awscli SSM command on all EC2 instances in the specified roles,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        description='Runs <enterprise id>-install-awscli SSM command on EC2 instances in a deployment with specified roles.')
    ...
    command_id = ssm_client.send_command(
        Targets=ssm_filters,
        DocumentName=args.enterprise_id + '-install-awscli',
