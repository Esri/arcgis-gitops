...
4. Set "deployment_fqdn" property to the ArcGIS Enterprise site domain name.
5. Commit the changes to the Git branch and push the branch to GitHub.
6. Run the enterprise-base-windows-azure-application workflow using the branch.
