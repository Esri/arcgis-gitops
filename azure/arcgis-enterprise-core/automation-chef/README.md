...
|------|-------------|------|---------|:--------:|
| arcgis_cookbooks_path | Blob name of Chef cookbooks for ArcGIS distribution archive in the repository bucket | `string` | `"cookbooks/arcgis-5.4.0-cookbooks.tar.gz"` | no |
