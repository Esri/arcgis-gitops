  ...
  managed_rules {
    ...
    managed_rule_set {
      ...
      rule_group_override {
        ...
        rule {
          id = "920120" # Attempted multipart/form-data bypass
        }

        rule {
          id = "920121" # Attempted multipart/form-data bypass
        }
      ...
      rule_group_override {
        ...
        rule {
          id = "99031001" # SQL Injection Attack: Common Injection Testing Detected
        }
      }
    }
    ...
    managed_rule_set {
      ...
      rule_group_override {
        ...
        rule {
          id = "300300" # General purpose HTTP clients and SDKs
        }

        rule {
          id = "300700" # Other bots
        }
      }
    }
