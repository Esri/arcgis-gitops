...
variable "notebook_server_authorization_file_path" {
  ...
  validation {
    ...
    error_message = "The file specified in notebook_server_authorization_file_path does not exist."
  }
}
...
variable "root_cert_file_path" {
  ...
  validation {
    ...
    error_message = "The file specified in root_cert_file_path does not exist."
  }
}
