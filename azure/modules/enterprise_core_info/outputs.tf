...
output "resource_group_name" {
  ...
  value       = "${var.enterprise_id}-infrastructure-core"
}

output "vault_name" {
  description = "Azure Key Vault Name"
  value       = data.azurerm_key_vault.enterprise_vault.name
}

output "vault_id" {
  description = "Azure Key Vault ID"
  value       = data.azurerm_key_vault.enterprise_vault.id
}

output "vault_uri" {
  description = "Azure Key Vault URI"
  value       = data.azurerm_key_vault.enterprise_vault.vault_uri
}

output "vnet_id" {
  description = "VNet ID of ArcGIS Enterprise"
...
output "storage_account_id" {
  ...
  value       = data.azurerm_storage_account.enterprise_storage.id
}

output "storage_account_blob_endpoint" {
  description = "Azure storage account primary blob endpoint"
  value       = data.azurerm_storage_account.enterprise_storage.primary_blob_endpoint
}
