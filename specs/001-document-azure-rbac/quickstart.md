...
3. For Terraform backend state, confirm the storage access role is listed separately as `Storage Blob Data Contributor` (or another data-plane role justified by the backend's actual operations).
